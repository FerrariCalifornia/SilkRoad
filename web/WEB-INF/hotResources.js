        ...
        success: function (jsonData) {
            ...
            for (var i = 0; i < jsonData.length; i++) {
                ...
                case 'pebook':
	                ...
	                var u1 = '<div style="broder-style:solid; broder-color:#000;width: 100%;height: 100px;margin-top: 20px">' +
	                    '<div style="position: relative;height: 70px;float: left;margin-left: 10px;word-break: break-word">' +
	                    '<p><a href="' + text_url + '"><strong style="font-size: 14px; color: #00adef">' + title + '</strong></a></p>' +
	                    '<p style="font-size: 12px; color: #999;">' + doi + date_publication + '</p>' +
	                    '<p style="font-size: 12px; color: #999; height: 36px; width: 90%; overflow: hidden;">' + summary + '</p>' +
	                    '</div>' +
	                    '</div>' +
                ...
                case 'regulation':
	                ...
	                var u1 = '<div style="broder-style:solid; broder-color:#000;width: 100%;height: 100px;margin-top: 20px">' +
	                    '<div style="position: relative;height: 70px;float: left;margin-left: 10px;word-break: break-word">' +
	                    '<p style="height: 36px; width: 90%; overflow: hidden;"><a href="' + url + '"><strong style="font-size: 14px; color: #00adef; width:80%;">' + title + '</strong></a></p>' +
	                    '<p style="font-size: 12px; color: #999;">' + doi + date_publication + '</p>' +
                ...
                case 'uansr':
	                ...
	                var u1 = '<div style="broder-style:solid; broder-color:#000;width: 100%;height: 100px;margin-top: 20px">' +
	                    ...
	                    '<p style="font-size: 12px; color: #999;">' + doi + year + '</p>' +
                ...
                case 'uebook':
	                ...
	                var u1 = '<div style="broder-style:solid; broder-color:#000;width: 100%;height: 100px;margin-top: 20px">' +
	                    ...
	                    '<p style="font-size: 12px; color: #999;">' + author + doi + '</p>' +
	                    '<p style="font-size: 12px; color: #999;">' + nation + year + '</p>' +
	                    '</div>' +
	                    '</div>' +
